...
public class RCImageClickView extends ClickImageView implements Checkable, RCAttrs {

    RCHelper mRCHelper;

    public RCImageClickView(Context context) {
        this(context, null);
    }

    public RCImageClickView(Context context, AttributeSet attrs) {
        super(context, attrs);
